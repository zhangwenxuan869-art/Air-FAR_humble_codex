...
def generate_launch_description():
    ...
    scan_cloud_default = PythonExpression([
        "'/terrain_map' if '",
        remap_profile,
        "' == 'far_ros2' else '/registered_scan'",
    ])
    terrain_local_default = PythonExpression([
        "'/registered_scan' if '",
        remap_profile,
        "' == 'far_ros2' else '/terrain_map'",
    ])
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="Select ROS2 far_planner-style or original Air-FAR ROS1-style cloud remaps.",
        ),
        ...
        DeclareLaunchArgument("terrain_local_topic", default_value=terrain_local_default),
        DeclareLaunchArgument("scan_cloud_topic", default_value=scan_cloud_default),
